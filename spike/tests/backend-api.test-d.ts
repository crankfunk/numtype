...
type T2 = Expect<Equal<(typeof fa)["shape"], [2, 3]>>;

const z = wasmBackend.zeros([2, 4]);
type T3 = Expect<Equal<(typeof z)["shape"], [2, 4]>>;

const o = wasmBackend.ones([3]);
type T4 = Expect<Equal<(typeof o)["shape"], [3]>>;
...
type T5 = Expect<Equal<(typeof matmulled)["shape"], [2, 4]>>;
