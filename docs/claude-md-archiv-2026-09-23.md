# Archiv: CLAUDE.md vor der Verschlankung (Stand 2026-09-23, HEAD 9855dac)

> Wortgetreue Kopie der CLAUDE.md, wie sie bis zur Prozess-Kalibrierung vom 2026-09-23
> galt (789 Zeilen). Die aktive CLAUDE.md trägt seitdem nur Regeln + IST-Stand; die
> Scheiben-Narrative und Pin-Historien stehen hier und in docs/projekt-log.md.
> Nicht mehr normativ — bei Widerspruch gilt die aktive CLAUDE.md.
